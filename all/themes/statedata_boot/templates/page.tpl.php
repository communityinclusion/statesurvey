...
<<<<<<< HEAD
 $site_name = in_array('MA user',$user->roles) ? "Massachusetts Department of Developmental Services Data Entry" : (in_array('MD user',$user->roles) ? "Maryland DDA Employment Outcome Information System" : ((in_array('GA user',$user->roles) || in_array('GA Admin',$user->roles)) ? "Georgia DBHDD Employment Outcome Information System" : "State Data Employment Outcome Information System"));
=======
