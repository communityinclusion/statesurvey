(function($) {
 ...
 Drupal.behaviors.remState = {
    ...
    Drupal.behaviors.startScan = {
      ...
      if (!$('#edit-group_indv_comp p.nextSec').length)$('#edit-group_indv_comp').append('<p class="nextSec"><a class="openTab" href="#edit-group_grp_integ">>> Next: Group integrate job >></a></p>');
   ...
   if (!$(elem).hasClass('redLine')){ $(elem).addClass('redLine');}
    ...
    else if ($(elem).prop('id') == 'edit-field-com-non-work-vol-partic-und' && $(elem).val() == '-1') {  countempty += 1;
